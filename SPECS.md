...
Plus simple markers (`232871`, `http://localhost:9080`, `Haus Sonnenschein`, `nicole.neckermann@icloud.com`, etc.) used by the AvailabilityCalendar and various inline texts.
